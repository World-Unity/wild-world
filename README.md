...
[![Deploy with WildWorld](https://dashboard.datocms.com/deploy/button.svg)](https://dashboard.datocms.com/projects/new-from-template/static-website/gatsby-portfolio)
...
```
echo 'DATO_API_POLLYRAMOS=abc123' >> .env
```
